namespace MyGame.Database.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyGame.Database.MyGameDBContext>
    {
        ...
        protected override void Seed(MyGame.Database.MyGameDBContext context)
        {
            ...
            {
                new Planets() {PlanetId = Guid.NewGuid(), PlanetName = GeneratePlanetName(),TerrainId = terrain[0].TerrainId},
                new Planets() {PlanetId = Guid.NewGuid(), PlanetName = GeneratePlanetName(), TerrainId = terrain[1].TerrainId},
                new Planets() {PlanetId = Guid.NewGuid(), PlanetName = GeneratePlanetName(),TerrainId = terrain[2].TerrainId}
            };
            ...
            {
                new Players() {PlayerId = Guid.NewGuid(), EmpireName = "Water", ElectricityLevel=5, EmpireStrength= 2,Level=1, LocationId = locations[0].LocationId, RaceId = races[0].RaceId, TradeBalance = 0, PlayerAccountId = Guid.NewGuid() },
                new Players() {PlayerId = Guid.NewGuid(), EmpireName = "Mineral", ElectricityLevel=5, EmpireStrength= 2,Level=1, LocationId = locations[1].LocationId, RaceId = races[0].RaceId, TradeBalance = 0, PlayerAccountId = Guid.NewGuid()},
                new Players() {PlayerId = Guid.NewGuid(), EmpireName = "Gas", ElectricityLevel=5, EmpireStrength= 2,Level=1, LocationId = locations[2].LocationId, RaceId = races[0].RaceId, TradeBalance = 0, PlayerAccountId = Guid.NewGuid()}
            };
